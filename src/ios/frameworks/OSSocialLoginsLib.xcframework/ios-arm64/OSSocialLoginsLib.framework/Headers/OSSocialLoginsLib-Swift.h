...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OSSocialLoginsLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface SocialLoginsAppleController (SWIFT_EXTENSION(OSSocialLoginsLib)) <ASAuthorizationControllerDelegate>
...
SWIFT_CLASS("_TtC17OSSocialLoginsLib30SocialLoginsLinkedInController")
@interface SocialLoginsLinkedInController : SocialLoginsBaseController
@end
